...
const APP_TEXT = {
    ...
    // (Main, Login, Dashboard, Creator は変更なし)
    ...
    Dashboard: { Logout: "ログアウト", BtnCreate: "セット作成", BtnConfig: "セット設定", BtnStudio: "スタジオ", BtnViewer: "モニター", SetListTitle: "保存済みセット", DeleteConfirm: "削除しますか？" },
    Creator: {
        Title: "問題作成", BackBtn: "ダッシュボード", LabelSetName: "セット名", PlaceholderSetName: "例: 第1ステージ", HeadingNewQ: "新規問題追加", HeadingEditQ: "問題編集",
        LabelType: "問題形式", TypeChoice: "選択式", TypeSort: "並べ替え", TypeText: "自由入力", PlaceholderQ: "問題文を入力", BtnAdd: "リストに追加", BtnUpdateQ: "更新する", BtnCancel: "キャンセル", ListHeading: "作成中のリスト", BtnSave: "クラウドに保存して完了", BtnUpdate: "更新して完了", OptMulti: "正解を選択",
        LabelTextFormat: "回答形式", TextFormatWritten: "記述式", TextFormatOral: "口頭 (正解入力任意)", LabelSortInitial: "初期配置", SortInitialRandom: "ランダム (推奨)", SortInitialFixed: "固定 (作成順)", DescSort: "※正解の順番（上から下）で入力してください", DescText: "※正解キーワード（カンマ区切り）",
        BtnAddChoice: "＋ 選択肢を追加", BtnAddSort: "＋ 項目を追加",
        HeadingSettings: "セット設定 (全体共通)", LabelLayout: "モニターレイアウト", LayoutStandard: "標準 (上:問題 / 下:選択肢)", LayoutSplitList: "左右分割 (右:縦書き問題 / 左:リスト)", LayoutSplitGrid: "左右分割 (右:縦書き問題 / 左:グリッド)", LabelAlign: "文字の配置", AlignLeft: "左揃え", AlignCenter: "中央揃え", AlignRight: "右揃え",
    ...
    // セット設定 (Config)
    Config: {
        Title: "セット設定", BackBtn: "ダッシュボード", HeadingAdd: "ピリオドを構成に追加", LabelSet: "セットを選択", SelectDefault: "-- セットを選択 --", SelectLoading: "読み込み中...", SelectEmpty: "セットがありません",
        ...
        LabelShuffle: "選択肢シャッフル", ShuffleOn: "する (ランダム配置)", ShuffleOff: "しない (固定配置)",
    ...
    Player: {
        ...
        // ★v51
        MsgTimeAttack: "Time Shock Mode"
    },

    // モニター
    Viewer: {
        Title: "モニター接続", BtnConnect: "接続する", Waiting: "WAITING...", AnswerCheck: "ANSWER CHECK"
    }
};

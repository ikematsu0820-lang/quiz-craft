/* =========================================================
 * text_config.js (v56: Fixed Type & Custom Time)
 * =======================================================*/

const APP_TEXT = {
    AppTitle: "Quiz Studio",
    Version: "Cloud Edition v56",
    ...
    Dashboard: { Logout: "ログアウト", BtnCreate: "問題作成", BtnConfig: "セット設定", BtnStudio: "スタジオ", BtnViewer: "モニター", SetListTitle: "保存済みセット", DeleteConfirm: "削除しますか？" },
    
    Creator: {
        Title: "問題作成", BackBtn: "ダッシュボード", 
        LabelSetName: "セット名", PlaceholderSetName: "例: 第1ステージ",
        
        // ★v56: 上部に移動した項目
        LabelTypeFixed: "問題形式 (セット内固定)", 
        TypeChoice: "選択式", TypeSort: "並べ替え", TypeText: "自由入力", TypeMulti: "多答クイズ",
        MsgTypeLocked: "※問題を追加したため形式はロックされています",

        HeadingNewQ: "新規問題追加", HeadingEditQ: "問題編集",
    ...
    Config: {
        ...
        LabelMode: "回答モード", ModeNormal: "一斉回答 (Simultaneous)", ModeBuzz: "早押し (Buzz-in)", ModeTurn: "順番回答 (Turn-based)", ModeTimeAttack: "★タイムショック (固定)", ModePanel: "★パネルアタック (固定)", ModeBomb: "ドボン / 宝探し (Bomb/Treasure)",
        ...
        // ★v56: カスタム設定用テキスト
        HeadingCustomScore: "問題別配点・失点・時間設定",
        LabelBulkTime: "時間一括:", LabelBulkPt: "得点一括:", LabelBulkLoss: "失点一括:", 
